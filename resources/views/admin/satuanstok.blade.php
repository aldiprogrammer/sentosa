                        ...
                        <div class="flex gap-2">
                            ...
                            <dialog id="my_modal_3" class="modal">
                                <div class="modal-box">
                                    ...
                                    <form method="post" action="{{ route('admin.satuanstok.store') }}"
                                        enctype="multipart/form-data">
                                        @csrf

                                        <label class="form-control w-full mt-2">
                                            <div class="label">
                                                <span class="label-text">Satuan Stok</span>
                                            </div>
                                            <input type="text" name="nama_satuan" placeholder=""
                                ...
                                @foreach ($satuan as $i => $item)
                                        ...
                                        <td>
                                            <div class="flex gap-2">
                                                ...
                                                <form id="delete-user-{{ $item->id }}"
                                                    action="{{ route('admin.satuanstok.delete', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <dialog id="my_modal_3{{ $item->id }}" class="modal">
                                        <div class="modal-box">
                                            ...
                                            <form method="post" action="{{ route('admin.satuanstok.update', $item->id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
