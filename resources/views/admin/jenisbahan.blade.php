                        ...
                        <div class="flex gap-2">
                            ...
                            <dialog id="my_modal_3" class="modal">
                                <div class="modal-box">
                                    ...
                                    <form method="post" action="{{ route('admin.jenisbahan.store') }}"
                                        ...
                                        <label class="form-control w-full mt-2">
                                            ...
                                            <input type="text" name="jenis_bahan" placeholder=""
                                ...
                                @foreach ($jenisbahan as $i => $item)
                                        ...
                                        <td>
                                            <div class="flex gap-2">
                                                ...
                                                <form id="delete-user-{{ $item->id }}"
                                                    action="{{ route('admin.jenisbahan.delete', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    <dialog id="my_modal_3{{ $item->id }}" class="modal">
                                        <div class="modal-box">
                                            ...
                                            <form method="post" action="{{ route('admin.jenisbahan.update', $item->id) }}"
                                                enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                ...
                                                <label class="form-control w-full mt-2">
                                                    ...
                                                    <input type="text" name="jenis_bahan" placeholder=""
                                                        ...
                                                        value="{{ $item->jenis_bahan }}" required />
                                                </label>
